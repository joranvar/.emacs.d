...
Based on something I found on [[http://www.emacswiki.org/emacs/AutoInsertMode][emacswiki.org]]:
...
#+BEGIN_SRC emacs-lisp
  (use-package autoinsert
    ...
    :config (progn
              ...
              (--each (directory-files auto-insert-directory t)
                (define-auto-insert (file-name-extension it) it))))
#+END_SRC
